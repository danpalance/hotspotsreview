...
typecomp_plots <- lapply(type_list, driver_plot)

# Save plots in a grid, 4 to a page
typecomp_plots1 <- cowplot::plot_grid(typecomp_plots[[1]], typecomp_plots[[2]],
                                      typecomp_plots[[3]], typecomp_plots[[4]],
                                      labels = c('A)', 'B)', 'C)', 'D)'),
                                      label_size = 18,
                                      label_fontface = "bold",
                                      align="hv") 
ggsave(plot = typecomp_plots1,"figs/typecomp_plots1.png", dpi = 600, 
       width = 7.5, height = 7.5, scale = 2)

typecomp_plots2 <- cowplot::plot_grid(typecomp_plots[[5]], typecomp_plots[[6]],
                                      typecomp_plots[[7]], typecomp_plots[[8]],
                                      labels = c('E)', 'F)', 'G)', 'H)'),
                                      label_size = 18,
                                      label_fontface = "bold",
                                      align="hv")
ggsave(plot = typecomp_plots2,"figs/typecomp_plots2.png", dpi = 600, 
       width = 7.5, height = 7.5, scale = 2)

typecomp_plots3 <- cowplot::plot_grid(typecomp_plots[[9]], typecomp_plots[[10]], 
                                      typecomp_plots[[11]], typecomp_plots[[12]],
                                      labels = c('I)', 'J)', 'K)', 'L)'),
                                      label_size = 18,
                                      label_fontface = "bold",
                                      align="hv")
ggsave(plot = typecomp_plots3,"figs/typecomp_plots3.png", dpi = 600, 
       width = 7.5, height = 7.5, scale = 2)

typecomp_plots4 <- cowplot::plot_grid(typecomp_plots[[13]], typecomp_plots[[14]], 
                                      NULL, NULL,
                                      labels = c('M)', 'N)'),
                                      label_size = 18,
                                      label_fontface = "bold",
                                      align="hv")
ggsave(plot = typecomp_plots4,"figs/typecomp_plots4.png", dpi = 600, 
       width = 7.5, height = 7.5, scale = 2)
